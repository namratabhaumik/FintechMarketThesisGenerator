...
def _run_thesis_pipeline(job_id: str, container: ServiceContainer, jm: IJobManager):
    ...
    so they are persisted to Supabase.
    """
    ...
    try:
        ...
        if not articles:
            ...
            jm.update_job(job_id, error="No articles found from RSS feeds")
            return
        jm.update_job(job_id, articles=articles)
        ...
        if not docs:
            ...
            jm.update_job(job_id, error="No relevant documents found for query")
            return
        jm.update_job(job_id, retrieved_docs=docs)
        ...
        jm.update_job(job_id, thesis=thesis)
        ...
        jm.update_job(job_id, error=str(e))
